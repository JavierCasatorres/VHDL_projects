...
proc create_root_design { parentCell } {
  ...
  connect_bd_intf_net -intf_net axi_vfifo_ctrl_0_M_AXIS [get_bd_intf_pins axi_vfifo_ctrl_0/M_AXIS] [get_bd_intf_pins fifo_generator_1/S_AXIS]
  connect_bd_intf_net -intf_net fifo_generator_0_M_AXIS [get_bd_intf_pins axi_vfifo_ctrl_0/S_AXIS] [get_bd_intf_pins fifo_generator_0/M_AXIS]
